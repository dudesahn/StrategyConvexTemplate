...
@pytest.fixture(scope="session")
def amount():
    amount = 75_000e18  # can do 20k for others, 7k for EURT
    yield amount
...
@pytest.fixture(scope="session")
def strategy_name():
    strategy_name = "StrategyConvexRAI"
    yield strategy_name


# this is the name of our strategy in the .sol file
@pytest.fixture(scope="session")
def contract_name(StrategyConvexOldPoolsClonable):
    contract_name = StrategyConvexOldPoolsClonable
    yield contract_name
