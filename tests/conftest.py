...
@pytest.fixture(scope="module")
def pid():
    pid = 63  # 13 USDN, 28 USDP, 55 EURT, RAI 63
    yield pid
...
@pytest.fixture(scope="module")
def amount():
    amount = 90_000e18  # can do 20k for others, 7k for EURT
    yield amount
...
def whale(accounts, amount, token):
    ...
    whale = accounts.at(
        "0x0210B1ed07Df594FD3aAc32832a6E1690554716a", force=True
    ...
    # RAI 0x0210B1ed07Df594FD3aAc32832a6E1690554716a, 180k
...
@pytest.fixture(scope="module")
def vault_address():
    vault_address = "0x2D5D4869381C4Fce34789BC1D38aCCe747E295AE"
...
# vaults with only convex strategy deployed currently, use pids for simplicity
@pytest.fixture(scope="module")
def convex_only():
    convex_only = [60, 63]
    # 3EUR, RAI
...
@pytest.fixture(scope="module")
def old_pool():
    old_pool = "0xcB636B81743Bb8a7F1E355DEBb7D33b07009cCCC"
...
@pytest.fixture(scope="module")
def no_profit():
    no_profit = False  # EURS getting nothing/low currently
    yield no_profit
    ...
    def strategy(
        ...
        if is_convex:
            ...
            if vault_address == ZERO_ADDRESS:
                ...
                if pid in convex_only:  # vaults with only convex strats attached
        ...
        if vault_address != ZERO_ADDRESS and pid not in convex_only:
