...
def whale(accounts, amount, token):
    ...
    whale = accounts.at("0x7a7A599D2384ed203cFEA49721628aA851E0DA16", force=True)
...
@pytest.fixture(scope="session")
def vault_address():
    vault_address = "0x625b7DF2fa8aBe21B0A976736CDa4775523aeD1E"
...
@pytest.fixture(scope="session")
def old_pool():
    old_pool = "0x4CA9b3063Ec5866A4B82E437059D2C43d1be596F"
...
@pytest.fixture(scope="session")
def strategy_name():
    strategy_name = "StrategyConvexHBTC"
    yield strategy_name


# this is the name of our strategy in the .sol file
@pytest.fixture(scope="session")
def contract_name(StrategyConvex2BTCClonable):
    contract_name = StrategyConvex2BTCClonable
    yield contract_name
...
def sleep_time():
    ...
    hours_to_sleep = 6  # 6 HBTC, 48 renBTC
