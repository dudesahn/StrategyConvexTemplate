...
@pytest.fixture(scope="session")
def contract_name(StrategyConvexEthVolatilePairsClonable):
    contract_name = StrategyConvexEthVolatilePairsClonable
    yield contract_name
...
def sleep_time():
    ...
    hours_to_sleep = 12  # 12 hours has no yield now for some reason
