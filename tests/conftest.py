...
@pytest.fixture(scope="session")
def strategy_name():
    strategy_name = "StrategyConvexoBTC"
    yield strategy_name


# this is the name of our strategy in the .sol file
@pytest.fixture(scope="session")
def contract_name(StrategyConvexsBTCMetapoolsOldClonable):
    contract_name = StrategyConvexsBTCMetapoolsOldClonable
    yield contract_name
...
def gauge_is_not_tokenized():
    gauge_is_not_tokenized = False  # True for tBTC
