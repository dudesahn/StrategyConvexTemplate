...
@pytest.fixture(scope="session")
def amount():
    amount = 20_000e18  # can do 20k for USDN/USDP, 7k for EURT, 500k for RAI
    yield amount
...
@pytest.fixture(scope="session")
def no_profit():
    no_profit = False  # EURT True, weirdly, even though Curve strat gets yield. False for all others
    yield no_profit
