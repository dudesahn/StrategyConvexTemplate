...
def whale(accounts, amount, token):
    ...
    whale = accounts.at(
        "0xeAC7cec448a0256eD471e66e240f69C165835c5d", force=True
    )  # 0xeAC7cec448a0256eD471e66e240f69C165835c5d (>72k total)
...
@pytest.fixture(scope="session")
def vault_address():
    vault_address = "0x4560b99C904aAD03027B5178CCa81584744AC01f"
    yield vault_address
...
@pytest.fixture(scope="session")
def strategy_name():
    strategy_name = "StrategyConvexcvxCRV"
    yield strategy_name


# this is the name of our strategy in the .sol file
@pytest.fixture(scope="session")
def contract_name(StrategyConvexcvxCRV):
    contract_name = StrategyConvexcvxCRV
    yield contract_name
